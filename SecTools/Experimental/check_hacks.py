...
rKnownFiles = [ # Ignore /tmp/ui.php as it's not always accessible by ODIN, and it can't be used anyway, knowledges hacks and scripts to clean.
...
if __name__ == "__main__":
    ...
    for rServer in rServers:
        ...
        if len(rResponse) > 1 and rResponse[0] == "xtreamcodes" and rResponse[1].upper() == "P":
            ...
            if len(rResponse) > 1 and rResponse[0] == "xtreamcodes" and rResponse[1].upper() == "P": print "Couldn't disable user password... Please disable it manually on the LB."
        ...
        if int(rServer[0]) == int(rConfig["server_id"]):
            ...
            if "xtreamcodes ALL=(ALL:ALL) NOPASSWD:ALL" in rSudoers:
                print "Odin user has unrestricted sudo! Fixing on main..."
        ...
        if rWriteServices:
            print " "
            print "Odin start_services.sh is infected! Fixing..."
    ...
    print " "
    print " "
    print "Odin Advanced Security is Done! Run this again to be sure..."
